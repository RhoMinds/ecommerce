...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div ref={storyRef} className="relative h-[340vh] bg-black md:h-[390vh]">
        <PremiumExperienceOverlay scrollYProgress={scrollYProgress} />
      </div>

      <section className="relative z-20 overflow-hidden bg-black px-6 py-20 text-white md:px-12 md:py-24">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="rounded-[34px] border border-white/12 bg-white/[0.04] p-6 backdrop-blur-xl md:p-8">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link
                  to="/contact"
                  className="inline-flex min-w-[220px] items-center justify-center gap-3 rounded-full bg-[#F9B303] px-8 py-4 text-xs font-semibold uppercase tracking-[0.22em] text-black transition hover:-translate-y-0.5 hover:bg-[#FFFFFF]"
                >
                  Book Consultation <ChevronRight className="h-4 w-4" />
                </Link>
                <Link
                  to="/shop"
                  className="inline-flex min-w-[220px] items-center justify-center gap-3 rounded-full border border-white/16 bg-white/[0.05] px-8 py-4 text-xs font-semibold uppercase tracking-[0.22em] text-white transition hover:-translate-y-0.5 hover:border-[#F9B303] hover:text-[#F9B303]"
                >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-14 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h3 className="mt-5 text-4xl font-semibold leading-[1.02] tracking-[-0.05em] text-white md:text-6xl">
